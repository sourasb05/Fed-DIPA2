...
from client.Usermoon import MOON_client # type: ignore


class MOON_server(Base_server):
    def __init__(self,device, args, exp_no, current_directory):
        ...
        for i in trange(self.total_users, desc="Data distribution to clients"):
            user = MOON_client(self.device, args, int(self.user_ids[i]), exp_no, current_directory, self.wandb)
