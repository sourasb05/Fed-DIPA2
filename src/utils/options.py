...
def args_parser():
    ...
    parser.add_argument("--user_ids", type=list, default=[['71', '7', '189', '202', '208', '0', '160', '10', '105', '68', '139', '207', '57', 
                                                         ...
                                                         '225', '184', '281', '88', '58', '295', '161', '250', '278', '50', '63', '176', '275', '52', 
                                                         '35', '109', '240', '219', '138', '291', '62', '224', '267', '98', '252', '178', '106', '146', 
                                                         '169', '80', '75', '60', '44', '180', '116', '210', '144', '203', '285', '37', '229', '212', '196', 
                                                         ...
                                                         '245', '112', '61', '233', '256', '83', '165', '168', '118', '64', '20', '177', '268', '147', '274', '158',
                                                         '195', '287', '77', '265', '211', '53', '81', '86', '134', '123', '154', '127', '216', '188', '56', '137', 
                                                         '103', '41', '2', '232', '26', '18', '1', '131', '288', '239', '31', '223', '231', '43', '263', '151', 
                                                         '140', '132', '159', '119', '91', '108', '130', '6', '101', '255', '237', '25', '152', '166', '87', '38', 
                                                         '32', '227', '82', '243', '111', '294', '42', '257', '183', '27', '90', '299', '214', '222', '298', '284',
                                                         '66', '251', '125', '269', '164', '271', '45', '198', '84', '246', '29', '150', '238', '293', '264', '156',
                                                         '12', '272', '70', '296', '266', '260', '249', '199', '142', '258', '48', '69', '114', '15', '85', '283', 
                                                         '254', '135', '59', '197', '171', '297', '247', '120', '292', '179', '191', '113', '100', '95', '65', '46', 
                                                         '230', '136', '192', '236', '34', '186', '170', '36', '102', '276', '24', '221', '289', '23', '11', '167', 
                                                        ...
                                                        ['329', '306', '325', '504', '584', '323', '369', '470', '597', '587', '524', '488', '482', '442', '503', 
                                                         ...
                                                         '446', '413', '576', '500', '391', '433', '538', '460', '585', '509', '326', '492', '478', '551', '393', 
